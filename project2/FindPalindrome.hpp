...
private:
	...
	int num; //this is a variable that will keep track of the number of words in the vector
	std::vector<std::string> words; //the vector that will hold all words in the sentance
	...
	bool isPalindrome(std::vector<std::string> stringVector) const;
